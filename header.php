...
<head>
	...
	<script async src="//www.googletagmanager.com/gtag/js?id=UA-109137132-1"></script>
	<script>
		window.dataLayer = window.dataLayer || [];
		function gtag(){dataLayer.push(arguments);}
		gtag('js', new Date());

		gtag('config', 'UA-109137132-1');
	</script>
...
<div id="page" class="site">
	...
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'mtp' ); ?></a>
		...
		<div id="main-header">
			...
			<div class="container">
				...
				<div class="site-branding">
					...
					$mtp_description = get_bloginfo( 'description', 'display' );

					if ( $mtp_description || is_customize_preview() ) :

						?>

						<p class="site-description"><?php echo $mtp_description; /* WPCS: xss ok. */ ?></p>
