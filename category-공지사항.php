	...
	<!-- Custom Code -->
		...
		<div id="primary" class="content-area">
			...
			<?php if ( have_posts() ) : ?>
				...
				<!-- 카테고리 배너 -->
				<a href="http://www.mt-police.com/livescore/스포츠중계-해외축구중계-mlb중계-nba중계/" class="cat-banner"><img src="https://www.mt-police.com/wp-content/uploads/2019/06/gongji-opt-833X121.gif" alt="공지사항 배너"></a>
